...
import { Banknote, Search, History, LogOut, Shield } from "lucide-react";

const navItems = [
  { to: "/cashier", icon: Search, label: "Recherche" },
  { to: "/cashier/payments", icon: Banknote, label: "Paiements" },
  { to: "/cashier/history", icon: History, label: "Historique" },
];
    ...
    <div className="min-h-screen flex flex-col bg-background">
      <header className="sticky top-0 z-40 bg-card border-b px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg">STFS Caisse</span>
        </div>
